...
function EditListing() {
  ...
  const [listing, setListng] = useState(false)
...
//Redirects to the home page if the listing is not user's
useEffect(() => {   
...
// sets userRef to the current user's uid
  useEffect(() => {
    setLoading(true)
    const fetchListing = async () => {
        try {
            ...
            if (listingSnap.exists()) {
                setListng(listingSnap.data())
                setFormData({...listingSnap.data(),address:listingSnap.data().location})
                setLoading(false)
            } else {
                navigate('/')
        ...
        <form onSubmit={onSubmit}>
          ...
          <div className='formPriceDiv'>
            <input
              ...
              required
            />
            {type === 'rent' ? <p className='formPriceText'>$ / Month</p>:<p className='formPriceText'>$</p>}
          </div>
